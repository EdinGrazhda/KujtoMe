...
class ChildrenController extends Controller
{
    ...
    {
        $this->authorizeResource(Children::class, 'child');
    }
    ...
    public function show(Children $child): JsonResponse
    {
        try {
    ...
    public function update(Request $request, Children $child): JsonResponse
    {
        try {
            $validated = $request->validate([
    ...
    public function destroy(Children $child): JsonResponse
    {
        try {
            Children::destroy($child->id);
