...
export default function ParentCreate() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Add Parent — No Child Missed" />
            <div className="flex flex-1 flex-col gap-6 p-6">
                <PageHeader
                    title="Add Parent"
                    description="Register a new parent or guardian and link their children."
                            ...
                            <div className="space-y-2">
                                ...
                                {children.length === 0 ? (
                                    <p className="text-xs text-muted-foreground">
                                        No children available. Add children
                                        first.
                                    </p>
                                ) : (
